<div class="mt-3">
    ...
    @include('livewire.portal.querymanagement.query.create')
    {{-- @include('livewire.portal.querymanagement.query.edit') --}}
                ...
                <div class="row g-2 align-items-sm-center">
                    ...
                    <div class="col">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="">
                                <h4 class="mb-0 ">{{__('Management of student requests')}} </h4>
                            </div>
                            <div class=" ms-auto">
                                <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#CreateQueryModal" type="button">
