<div wire:ignore.self class="modal side-layout-modal fade" id="CreateTypeModal"  tabindex="-1"
            ...
            <div class="modal-body p-0">
                <div class="p-3 p-lg-4">
                    <div class="mb-4 mt-md-0">
                        <h1 class="mb-0 h4">{{ __('Create new Type Query') }}</h1>
                        <p>{{ __('Create Type Query') }} &#128522;</p>
                    </div>
